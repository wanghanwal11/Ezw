      ...
      <div style="height: 65px;">
        ...
        <x-header style="background: white;position: fixed;width: 100%;z-index: 99;top: 15px">
          <div slot="overwrite-left" style="color: black;display: -webkit-box;">
            ...
            <div style="font-size: 18px;padding: 1px 10px;">修改手机</div>
          </div>
        </x-header>
      </div>
      <div style="padding: 18px;text-align: center">
        <div style="line-height: 60px">安全验证</div>
        <div style="font-size: 14px;line-height: 30px;color: #999999">为了保证您的账号安全，需要验证身份，验证成功后可以进行下一步操作</div>
        <div style="line-height: 85px">+{{phone|toTel}}</div>
      </div>
      <div style="padding: 10px 18px">
        <x-button style="background-color: #ff6000;color: white;" @click.native="yanzheng">获取验证码</x-button>
      </div>
    </div>
</template>
